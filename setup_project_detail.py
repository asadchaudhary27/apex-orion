...
with open(r"E:\Apex orion\src\pages\ProjectDetail.tsx", "w") as f:
    f.write(content)

print("Created ProjectDetail.tsx")

# Update App.tsx
with open(r"E:\Apex orion\src\App.tsx", "r") as f:
    app_content = f.read()

if "const ProjectDetail = lazy(() => import('./pages/ProjectDetail'));" not in app_content:
    ...
    with open(r"E:\Apex orion\src\App.tsx", "w") as f:
        f.write(app_content)
