...
export const FEATURED_PROJECTS: FeaturedProject[] = [
  ...
  {
    id: 'ecommerce',
    title: 'Nexus Global E-Commerce Storefront',
    category: 'E-Commerce Platform',
    description: 'Edge-rendered global shopping experience with automated inventory management and instant multi-currency checkout.',
    metrics: '99.99% Uptime | 98 Lighthouse',
    stack: ['Next.js', 'Stripe', 'Tailwind', 'PostgreSQL'],
    mockupBg: 'from-[#FF5722]/40 via-orange-500/30 to-black',
    visualizationType: 'ecommerce',
  },
  {
    id: 'pos',
