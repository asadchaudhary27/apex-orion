...
export const SERVICES_DATA: ServiceCardData[] = [
  ...
  },
  {
    ...
    title: 'SEO Guest Posting',
    shortDesc: 'High-authority backlink building to dominate search rankings and drive massive organic traffic. We use strictly white-hat outreach to secure permanent contextual placements on high DA/DR websites relevant to your exact niche.',
    highlights: ['High DA/DR Sites Only', 'White-Hat Outreach', 'Traffic Boosting', 'Contextual Placements', 'Monthly Rank Reporting'],
    icon: Search,
